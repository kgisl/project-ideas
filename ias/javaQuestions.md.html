...
<li>
<ul>
<li><a href="#what-is-difference-between-isa-and-hasa-relationship">What is difference between isA and hasA relationship?</a></li>
<li><a href="#why-static-attributes-and-methods">Why static attributes and methods?</a></li>
<li><a href="#what-is-an-abstract-class-and-abstract-method-in-java-when-should-i-use-it-tutorial-attached">What is an Abstract Class and Abstract Method in Java? When Should I use it? Tutorial Attached</a></li>
<li><a href="#what-is-interface-class-in-java">What is interface class in Java?</a></li>
<li><a href="#final-hr-round">Final HR round</a></li>
</ul>
</li>
</ul>
  ...
  <div class="stackedit__right">
    <div class="stackedit__html">
      <h2 id="what-is-difference-between-isa-and-hasa-relationship">What is difference between isA and hasA relationship?</h2>
<ul>
