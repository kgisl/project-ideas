...
|Structural Programming|is a Programming Language Theory deals with design, implementation and classification of programming languages and features. An arhetype to acheive clarity, quality and development time of the computer by making use of extensive use of modulairty with only three ways sequence, selection and iteration 
|Why Structural Programming| It is a precursor to OOP.**Edsger W.Dijkstra** widely used structured programming a way to avoid **spaghetti code**.Logical way of thinking to solve a problem in all arenas in applying decomposition into a hierarchial structure (https://www.computer.org/csdl/mags/co/1981/03/01667281.pdf.)  |
