...
|Practically, everything is a graph | Read about the propaganda  [here](http://www.tcl-sfs.uni-tuebingen.de/~cornell/prolog/Propaganda.html) and [here](http://www.tcl-sfs.uni-tuebingen.de/~cornell/prolog/Graphs001.html) as well |Context Oriented Programming(COP) | is a programming paradigm supporting software adaptation to the execution context. COP provides mechanisms to dynamically adapt behaviour in reaction to the changes of behavior even after system deployment at time. Retaining language agnostic view and subject determines the function calls. (http://www.swa.hpi.uni-potsdam.de/cop/)|
|Why COP|As applications and services can be deeply personalised and that ranges from pervasive computing to business applications.Current business scenario depends on the customisation of the users requirements.  (https://www.cl.cam.ac.uk/techreports/UCAM-CL-TR-854.pdf), (http://www.jot.fm/issues/issue_2008_03/article4.pdf) |
|Structural Programming|is a archetype to achieve clarity, quality and reduced development time by making extensive use of modularity with only three constructs: sequence, selection and iteration |
