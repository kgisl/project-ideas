...
|Memory| 
(bits, nibbles, CPU registers, cache, RAM, disk, tape) that help store and retrieve data 
...
|Structural programming | is a programming paradigm that requires structural thinking |
