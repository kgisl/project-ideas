...
|Why Structural Programming?| It is a precursor to OOP. **Edsger W.Dijkstra** pervasively used structured programming as a way to avoid **spaghetti code**. Logical way of thinking to solve a problem in all areas by applying decomposition to generate a hierarchical structure.|
